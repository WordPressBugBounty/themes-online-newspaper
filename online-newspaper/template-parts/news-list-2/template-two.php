                ...
                <article class="list-item online-newspaper-category-no-bk <?php if(!has_post_thumbnail()){ echo esc_attr('no-feat-img');} ?>">
                   <div class="blaze_box_wrap online-newspaper-card">
                        <figure class="post-thumb-wrap">
                            <?php
                                if( $numbering > 1 ) {
                                    echo '<span class="post-numbering">' . online_newspaper_numbering_with_pad_format($numbering). '</span>';
                                } else {
                                    ?>
                        ...
                        <div class="post-element">
                            ...
                            <?php if( $numbering == 1 ) echo '<span class="post-numbering">' . online_newspaper_numbering_with_pad_format($numbering). '</span>'; ?>
                        </div>
                    </div>
                </article>
            <?php
