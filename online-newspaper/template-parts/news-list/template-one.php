...
?>
<div id="<?php echo esc_attr( $uniqueID . $block_id_attribute ); ?>" class="news-list<?php if( isset($options[ 'thumbOption' ]) && ! $options[ 'thumbOption' ] ) echo ' section-no-thumbnail'; ?> <?php echo esc_attr( 'layout--' . $options[ 'layout' ] );?>">
    <?php
                ...
                <article class="list-item <?php if(!has_post_thumbnail()){ echo esc_attr('no-feat-img');} ?>">
                   <div class="blaze_box_wrap online-newspaper-card">
                        ...
                        <div class="post-element">
                            ...
                            <?php endif;
                                do_action( 'online_newspaper_section_block_view_all_hook', array(
                                    'buttonOption'    => isset( $options[ 'buttonOption' ] ) ? $options[ 'buttonOption' ] : false
                                ));
                            ?>
                        </div>
                    </div>
