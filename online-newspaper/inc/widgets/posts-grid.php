<?php
/**
 * Adds Online_Newspaper_Posts_Grid_Widget widget.
 * 
 * @package Online Newspaper
 * @since 1.0.0
 */
class Online_Newspaper_Posts_Grid_Widget extends WP_Widget {
    /**
     * Register widget with WordPress.
     */
    public function __construct() {
        parent::__construct(
            'online_newspaper_posts_grid_widget',
            esc_html__( 'Online Newspaper : Posts Grid', 'online-newspaper' ),
            array( 'description' => __( 'A collection of posts from specific category displayed in grid layout.', 'online-newspaper' ) )
        );
    }
    ...
    ?>
            <div class="posts-wrap posts-grid-wrap feature-post-block <?php echo esc_attr( $widget_layout ); ?>">
                <?php
                    ...
                    ?>
                            <div class="post-item format-standard online-newspaper-card <?php if( $widget_layout == 'layout-two'){ echo esc_attr('online-newspaper-category-no-bk'); } ?>">
...
} // class Online_Newspaper_Posts_Grid_Widget