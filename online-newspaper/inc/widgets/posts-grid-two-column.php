<?php
/**
 * Adds Online_Newspaper_Posts_Grid_Two_Column_Widget widget.
 * 
 * @package Online Newspaper
 * @since 1.0.0
 */
class Online_Newspaper_Posts_Grid_Two_Column_Widget extends WP_Widget {
    /**
     * Register widget with WordPress.
     */
    public function __construct() {
        parent::__construct(
            'online_newspaper_posts_grid_two_column_widget',
            esc_html__( 'Online Newspaper : Posts Grid 2 Column', 'online-newspaper' ),
            array( 'description' => __( 'A collection of posts from specific category displayed in grid two column layout.', 'online-newspaper' ) )
        );
    }
                ...
                <?php
                    ...
                    ?>
                        <div class="blaze_box_wrap">
                            <div class="post-item online-newspaper-card format-standard <?php if( $widget_layout == 'layout-two'){ echo esc_attr('online-newspaper-category-no-bk'); } ?>">
...
} // class Online_Newspaper_Posts_Grid_Two_Column_Widget