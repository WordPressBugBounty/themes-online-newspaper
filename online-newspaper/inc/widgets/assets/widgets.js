...
jQuery(document).ready( function($) {
    ...
    // repeater field handler
        ...
        $(document).on( "change", ".online-newspaper-repeater-field .single-field-form-field", function(event) {
            event.preventDefault()
            var _thisParent = $(this).parents(".online-newspaper-repeater-field")
            $(this).val( event.target.value )
            renderRepeaterValue(_thisParent)
        })

        // on item edit area toggle
        $(document).on( "click", ".online-newspaper-repeater-field .single-item-heading", function(event) {
            event.preventDefault()
        ...
        // on item remove
        $(document).on( "click", ".online-newspaper-repeater-field .single-item-actions .remove-item", function(event) {
            event.preventDefault()
            var removeItemButton = $(this)
            var _thisParent = removeItemButton.parents(".online-newspaper-repeater-field")
            removeItemButton.parents(".repeater-single-item").remove()
            renderRepeaterValue(_thisParent)
        })

        // trigger image upload
        $(document).on( "click", ".online-newspaper-repeater-field .image-field .upload-image", function(event) {
            event.preventDefault();
            var uploadButton = $(this)
            var _thisParent = uploadButton.parents(".online-newspaper-repeater-field")
            if ( frame ) {
                frame.open();
                return;
            }
        ...
        $(document).on( "click", ".online-newspaper-repeater-field .image-field .remove-image", function(event) {
            event.preventDefault();
            var removeButton = $(this)
            var _thisParent = removeButton.parents(".online-newspaper-repeater-field")
        ...
        // on add item
        $(document).on( "click", ".online-newspaper-repeater-field .add-item", function(event) {
            event.preventDefault()
            var addFieldButton = $(this)
            var _thisParent = addFieldButton.parents(".online-newspaper-repeater-field")
            var parentContainer = addFieldButton.parents(".online-newspaper-repeater-field"), newItemToRender = parentContainer.find( ".repeater-field-content-area" ), newItem = parentContainer.find( ".repeater-field-content-area .repeater-single-item" ).last().clone()
    ...
    function online_newspaper_widgets_handler() {
        // multicheckbox field
        $( ".online-newspaper-multicheckbox-field" ).on( "click, change", ".multicheckbox-content input", function() {
            var _this = $(this), parent = _this.parents( ".online-newspaper-multicheckbox-field" ), currentVal, currentFieldVal = parent.find( ".widefat" ).val();
        ...
        // checkbox field
        $( ".online-newspaper-checkbox-field" ).on( "click, change", "input", function() {
            var _this = $(this)
            if( _this.is(":checked") ) {
                _this.val( "1" )
            } else {
        ...
        // upload field
        $( ".online-newspaper-upload-field" ).on( "click", ".upload-trigger", function(event) {
            event.preventDefault();
            if ( frame ) {
                frame.open();
                return;
        ...
        // remove image
        $( ".online-newspaper-upload-field" ).on( "click", ".upload-buttons .remove-image", function(event) {
            event.preventDefault();
            var _this = $(this);
        ...
        // icon text handler
        var iconTextContainer = $( ".online-newspaper-icon-text-field" )
    ...
    online_newspaper_widgets_handler();
