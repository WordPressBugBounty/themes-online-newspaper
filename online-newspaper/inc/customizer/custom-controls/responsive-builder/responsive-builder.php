 ...
 * @since 1.0.0
 */
if( ! class_exists( 'Online_Newspaper_WP_Responsive_Builder_Control' ) ) :
    class Online_Newspaper_WP_Responsive_Builder_Control extends Online_Newspaper_WP_Base_Control {
        // control type
        ...
        public function enqueue() {
            wp_enqueue_script( 'online-newspaper-responsive-builder-js', get_template_directory_uri() . '/inc/customizer/custom-controls/responsive-builder/responsive-builder.js', ['jquery'], ONLINE_NEWSPAPER_VERSION, [ 'strategy' => 'defer', 'in_footer' => true ] );
        }
