...
if( class_exists( 'WP_Customize_Control' ) ) :
    class Online_Newspaper_WP_Icon_Picker_Control extends \WP_Customize_Control {
        /**
         * Control type
         * 
         */
        ...
        public function enqueue() {
            wp_enqueue_style( 'online-newspaper-customizer-icon-picker', get_template_directory_uri() . '/inc/customizer/custom-controls/icon-picker/control.css', array(), ONLINE_NEWSPAPER_VERSION, 'all' );
            wp_enqueue_media();
            wp_enqueue_script( 'online-newspaper-customizer-icon-picker', get_template_directory_uri() . '/inc/customizer/custom-controls/icon-picker/control.js', array('jquery'), ONLINE_NEWSPAPER_VERSION, true );
        }
    ...
    ?>
            <div class="customize-icon-picker">
                ...
                <?php 
                    ...
                    $icons_array = online_newspaper_get_all_fontawesome_icons();
                    if( $icons_array ) :
                        echo '<div class="icon-picker-modal" style="display:none">';
                            echo '<div class="icon-picker-search">';
                                echo '<input type="search" placeholder="' .esc_html__( 'Type to search . .', 'online-newspaper' ). '"/>';
                            echo '</div>';
