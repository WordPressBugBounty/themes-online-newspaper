	...
	api.controlConstructor['builder'] = api.Control.extend({
        ...
        addCustomSectionClass: function( sections, toSkip ) {
            sections.map(( section ) => {
                ...
                sectionContainer.addClass( 'online-newspaper-builder-related' )    // ul
                if( toSkip !== section ) sectionInstance.headContainer.addClass( 'online-newspaper-builder-related-parent' )    // li
            })
        },
        addIsActiveClass: function( container, builderSettingsSection ) {
            ...
            sectionInstance.expanded.bind(function ( isExpanded ) {
                if ( isExpanded ) {
                    ...
                    sectionContent.parents( '#customize-controls' ).siblings('#customize-preview').addClass( 'online-newspaper-builder--on' )
                }
            });
            ...
            sectionContainerBackButton.on("click", function(){
                ...
                sectionContent.parents( '#customize-controls' ).siblings('#customize-preview').removeClass( 'online-newspaper-builder--on' )
            })
        },
        ...
        addCommonBuilderClass: function( parentContainer ) {
            parentContainer.addClass( 'online-newspaper-builder' )
        }
    });
} )( wp.customize, jQuery );