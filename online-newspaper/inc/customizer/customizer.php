<?php
/**
 * Online Newspaper Theme Customizer
 *
 ...
 */
function online_newspaper_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
    $wp_customize->get_section( 'background_image' )->title = esc_html__( 'Background', 'online-newspaper' );
    $wp_customize->get_section( 'background_image' )->priority = 90;
    $wp_customize->get_section( 'colors' )->title = esc_html__( 'Presets Colors', 'online-newspaper' );
    $wp_customize->get_section( 'colors' )->panel = 'online_newspaper_colors_panel';
     ...
     * @since 1.0.0
     */
    $wp_customize->add_panel( 'online_newspaper_colors_panel', array(
        'title' => esc_html__( 'Colors', 'online-newspaper' ),
        'priority'  => 7
    ));
    ...
    require get_template_directory() . '/inc/customizer/custom-controls/popup/popup.php'; // popup
    ...
    // range control
    class Online_Newspaper_WP_Range_Control extends Online_Newspaper_WP_Base_Control {
        // control type
        public $type = 'range';
    ...
    class Online_Newspaper_WP_Responsive_Range_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    // toggle control 
    class Online_Newspaper_WP_Toggle_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    class Online_Newspaper_WP_Simple_Toggle_Control extends Online_Newspaper_WP_Base_Control {
        // control type
        public $type = 'simple-toggle';
    }

    // block repeater control 
    class Online_Newspaper_WP_Block_Repeater_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    // spacing control
    class Online_Newspaper_WP_Spacing_Control extends Online_Newspaper_WP_Base_Control {
        // control type
        public $type_array = [];
        public $type = 'spacing';
        public $input_attrs = [
    ...
    class Online_Newspaper_WP_Item_Sortable_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    // typography control 
    class Online_Newspaper_WP_Typography_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    // box shadow control 
    class Online_Newspaper_WP_Box_Shadow_Control extends Online_Newspaper_WP_Base_Control {
        // control type
        public $type = 'box-shadow';
    }

    // border control - renders border property control
    class Online_Newspaper_WP_Border_Control extends Online_Newspaper_WP_Base_Control {
        // control type
        public $type = 'border';
    ...
    class Online_Newspaper_WP_Section_Tab_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    // radio tab control
    class Online_Newspaper_WP_Radio_Tab_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    // radio tab control
    class Online_Newspaper_WP_Responsive_Multiselect_Tab_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    // tab group control
    class Online_Newspaper_WP_Default_Color_Control extends WP_Customize_Color_Control {
        /**
    ...
    // info box control
    class Online_Newspaper_WP_Info_Box_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    class Online_Newspaper_WP_Social_Share_New_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    // preset control
    class Online_Newspaper_WP_Preset_Colors_Control extends Online_Newspaper_WP_Base_Control {
        public $type = 'preset-colors';
        public $blend = 'solid';
        public $variable = '--online-newspaper-global-preset-color-';
        ...
        public function to_json() {
            ...
            $this->variable = ( ( $this->blend === 'solid' ) ? $this->variable : '--online-newspaper-global-preset-gradient-color-' );
            $this->json['variable'] = $this->variable;
        }
    }

    // multiselect control
    class Online_Newspaper_WP_Async_Multiselect_Control extends Online_Newspaper_WP_Base_control {
        // control type
    ...
    // multiselect control
    class Online_Newspaper_WP_Multiselect_Control extends Online_Newspaper_WP_Base_control {
        // control type
    ...
    // color Control
	class Online_Newspaper_WP_Color_Control extends Online_Newspaper_WP_Base_Control {
		// control type
    ...
    class Online_Newspaper_WP_Theme_Color_Control extends Online_Newspaper_WP_Base_Control {
        // control type
    ...
    // number control
    class Online_Newspaper_WP_Number_Range_Control extends Online_Newspaper_WP_Base_Control {
        // control type
	...
	class Online_Newspaper_WP_Preset_Control extends Online_Newspaper_WP_Base_Control {
		// control type
		public $type = 'preset';
    ...
    // Term colors
	class Online_Newspaper_WP_Term_Colors extends Online_Newspaper_WP_Base_Control {
		// control type
        public $type = 'term-colors';
        public $terms = [];
        ...
        public function to_json() {
            parent::to_json();
			$this->json['terms'] = $this->terms;
        }
	}

    // typography preset Control
	class Online_Newspaper_WP_Typography_Preset_Control extends Online_Newspaper_WP_Base_Control {
		// control type
		public $type = 'typography-preset';
	}

    // multiselect control
    class Online_Newspaper_WP_Post_Multiselect_Control extends Online_Newspaper_WP_Base_control {
        // control type
        public $type = 'async-multiselect';
        public $endpoint = 'extend/get_posts';
	...
	class Online_Newspaper_WP_Responsive_Radio_Image extends Online_Newspaper_WP_Base_Control {
		// control type
    ...
    // Builder Reflector
	class Online_Newspaper_WP_Builder_Reflector_Control extends Online_Newspaper_WP_Base_Control {
		// control type
	...
	class Online_Newspaper_WP_Responsive_Radio_Tab_Control extends Online_Newspaper_WP_Base_Control {
		// control type
    ...
    $wp_customize->register_control_type( 'Online_Newspaper_WP_Radio_Image_Control' );
    $wp_customize->register_control_type( 'Online_Newspaper_WP_Editor_Control' );
}
add_action( 'customize_register', 'online_newspaper_customize_register' );

add_filter( ONLINE_NEWSPAPER_PREFIX . 'unique_identifier', function($identifier) {
    $n_delimeter = '-';
    $n_prefix = 'customize';
    $n_sufix = 'control';
...
if( ! function_exists( 'online_newspaper_customizer_orderby_options_array' ) ) :
    /**
     * Array of order by control choices
     * 
     * @since 1.0.0
     */
    function online_newspaper_customizer_orderby_options_array() {
        return apply_filters( 'online_newspaper_customizer_orderby_options_array', [
			'date-desc' =>  esc_html__( 'Newest - Oldest', 'online-newspaper' ),
			'date-asc' =>  esc_html__( 'Oldest - Newest', 'online-newspaper' ),
			'title-asc' =>  esc_html__( 'A - Z', 'online-newspaper' ),
			'title-desc' =>  esc_html__( 'Z - A', 'online-newspaper' ),
			'rand-desc' =>  esc_html__( 'Random', 'online-newspaper' )
		]);
    }
endif;

if( ! function_exists( 'online_newspaper_get_all_fontawesome_icons' ) ) :
	/**
	 ...
	 * 
	 */
	function online_newspaper_get_all_fontawesome_icons( $type = '' ) {
        $fontawesome_icons = [
...
function online_newspaper_get_image_sizes_option_array_for_customizer() {
	$sizes_lists = [];
...
require get_template_directory() . '/inc/customizer/render.php'; // render
require get_template_directory() . '/inc/customizer/helpers.php'; // helpers