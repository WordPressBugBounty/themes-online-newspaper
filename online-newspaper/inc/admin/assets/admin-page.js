...
jQuery( document ).ready(function( $ ){
    var ajaxUrl = onlineNewspaperThemeInfoObject.ajaxUrl, _wpnonce = onlineNewspaperThemeInfoObject._wpnonce
    // not having importer
        ...
        buttonContainer.each( function(){
            ...
            _thisButton.on( 'click', function( event ){
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {
                        "action": "online_newspaper_importer_plugin_action",
                        "_wpnonce": _wpnonce,
    ...
    // view all button
    var ViewAllContainer = $('#online-newspaper-info-page')
