...
namespace Online_Newspaper_Admin;
...
if( ! class_exists( 'Admin_Page' ) ) :
    ...
    class Admin_Page {
        ...
        public function __construct() {
            ...
            add_action( 'admin_menu', [ $this, 'online_newspaper_info_page' ], 10 );
            add_action( 'admin_enqueue_scripts', [ $this, 'admin_scripts' ] );
            add_action( 'wp_ajax_online_newspaper_importer_plugin_action', array( $this, 'online_newspaper_importer_plugin_action' ) );
            new Admin_Notices();
        }
        ...
        public function admin_scripts( $hook ) {
            if( $hook == 'toplevel_page_online-newspaper-info' ) {
                wp_enqueue_style( 'online-newspaper-info', get_template_directory_uri() . '/inc/admin/assets/admin-page.css', [], ONLINE_NEWSPAPER_VERSION, 'all' );
                wp_enqueue_script( 'online-newspaper-info', get_template_directory_uri() . '/inc/admin/assets/admin-page.js', [], ONLINE_NEWSPAPER_VERSION, true );
            }
            wp_enqueue_script( 'online-newspaper-notice', get_template_directory_uri() . '/inc/admin/assets/admin-notice.js', [], ONLINE_NEWSPAPER_VERSION, true );
            wp_enqueue_style( 'online-newspaper-info-notice', get_template_directory_uri() . '/inc/admin/assets/admin-notice.css', [], ONLINE_NEWSPAPER_VERSION, 'all' );
            wp_localize_script( 'online-newspaper-info', 'onlineNewspaperThemeInfoObject', array(
                'ajaxUrl'   => admin_url( 'admin-ajax.php' ),
                '_wpnonce'  => wp_create_nonce( 'online-newspaper-theme-info-nonce' )
            ));
            wp_localize_script( 'online-newspaper-notice', 'onlineNewspaperNoticeOject', array(
                'ajaxUrl'   => admin_url( 'admin-ajax.php' ),
                '_wpnonce'  => wp_create_nonce( 'online-newspaper-notice-nonce' ),
                'welcomeOption' =>  'online_newspaper_welcome_notice_dismiss'
            ));
        }
    
        /**
         * Function to Online Newspaper Info admin menu page
         * 
         * @since 1.0.0
         */
        public function online_newspaper_info_page() {
            add_menu_page( 
                esc_html__( 'Online Newspaper Info', 'online-newspaper' ),
                esc_html__( 'Online Newspaper Info', 'online-newspaper' ),
                'manage_options',
                'online-newspaper-info',
                [ $this, 'online_newspaper_info_callback' ],
                '',
                59
            );
        }
        ...
        /**
         * Callback function when registering Online Newspaper Info admin menu page
         * 
         * @since 1.0.0
         */
        public function online_newspaper_info_callback() {
            $starter_sites_class = 'starter-sites-section-wrap';
            if( array_key_exists( 'online_newspaper_importer_activated', $_POST ) ) :
                $nonce = $_POST['online_newspaper_importer_activated'];
                if ( wp_verify_nonce( $nonce, 'online_newspaper_form_action' ) ) $starter_sites_class .= ' active';
            endif;
            ?>
                <div class="online-newspaper-info-page" id="online-newspaper-info-page">
                    <div class="online-newspaper-info-page-inner box-container">
            ...
            ?>
                <div class="internal-links-section admin--card">
                    <div class="card-header">
                        ...
                        <div class="card-description"><?php echo esc_html__( 'Theme provides handy customizer that allows you to modify the site looks. You can click on the below links to navigate to the particular sections.', 'online-newspaper' ); ?></div>
                    </div>
                    <ul class="internal-links-section-list">
                        <li class="list-item">
                            <span class="dashicons dashicons-admin-customizer"></span>
                            <a href="<?php echo admin_url( 'customize.php' ); ?>" target="_blank"><?php echo esc_html__( 'Customize Site', 'online-newspaper' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-heading"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[control]=header_builder_section_width' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Header', 'online-newspaper' ); ?>
                            </a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-edit"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[control]=single_layout' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Single Post', 'online-newspaper' ); ?>
                            </a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-edit"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[control]=page_width_layout_header' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Single Page', 'online-newspaper' ); ?>
                            </a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-editor-ul"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[control]=archive_page_layout' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Archive', 'online-newspaper' ); ?>
                            </a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-hammer"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[control]=footer_builder_section_width' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Footer', 'online-newspaper' ); ?>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        public function external_links_section() {
            ?>
                <div class="external-links-section admin--card">
                    <div class="card-header">
                        <h2 class="card-title"><?php echo esc_html__( 'Several outside resources to help you fully understand the theme.', 'online-newspaper' ); ?></h2>
                        <div class="card-description"><?php echo esc_html__( 'We offer blogs, demos, documentation, and support forums for quick assistance. We hope this makes it easier for you.', 'online-newspaper' ); ?></div>
                    </div>
                    <ul class="external-links-section-list">
                        <li class="list-item">
                            <span class="dashicons dashicons-star-filled"></span>
                            <a href="<?php echo esc_url( '//wordpress.org/support/theme/online-newspaper/reviews/?filter=5' ); ?>" target="_blank"><?php echo esc_html__( 'Leave a review', 'online-newspaper' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-media-document"></span>
                            <a href="<?php echo esc_url( '//doc.blazethemes.com/online-newspaper/' ); ?>" target="_blank"><?php echo esc_html__( 'Documentation', 'online-newspaper' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-visibility"></span>
                            <a href="<?php echo esc_url( '//preview.blazethemes.com/online-newspaper-one/' ); ?>" target="_blank"><?php echo esc_html__( 'View demo', 'online-newspaper' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-admin-site"></span>
                            <a href="<?php echo esc_url( '//www.blazethemes.com' ); ?>" target="_blank"><?php echo esc_html__( 'Official site', 'online-newspaper' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-welcome-write-blog"></span>
                            <a href="<?php echo esc_url( '//blazethemes.com/blog/ ' ); ?>" target="_blank"><?php echo esc_html__( 'Blog', 'online-newspaper' ); ?></a>
                        </li>
                    </ul>
                </div>
            <?php
        ...
        public function recommended_section() {
            ?>
                <div class="recommended-section admin--card">
                    <div class="card-header">
                        <h2 class="card-title"><?php echo esc_html__( 'Recommended Plugins', 'online-newspaper' ); ?></h2>
                        <div class="card-description"><?php echo esc_html__( 'We recommend different useful plugins that can boost functionality, security, and user experience on your site.', 'online-newspaper' ); ?></div>
                    </div>
                                        ...
                                        <li class="list-item">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <span class="item-version">
                                                    <?php
                                                        echo esc_html__( 'Version: ', 'online-newspaper' );
            ...
            ?>
                <div class="starter-sites-section off-canvas">
                    <div class="canvas-header">
                        <h2 class="canvas-title"><?php echo esc_html__( 'All starter sites', 'online-newspaper' ); ?></h2>
                        <div class="canvas-description"><?php echo esc_html__( 'Professionally Designed Starter Sites — Choose Your Perfect Style and Launch Your Website in Minutes', 'online-newspaper' ); ?></div>
                    </div>
                    <?php
                            ...
                            <span class="status-message">
                                <?php
                                    if( in_array( $status, [ 'not-installed', 'inactive' ] ) ) :
                                        ...
                                        $prefix = ( $status == 'not-installed' ) ? esc_html__( ' to install and activate one click demo importer plugin', 'online-newspaper' ) : esc_html__( ' to activate one click demo importer plugin', 'online-newspaper' ) ;
                                        echo esc_html__( 'Click', 'online-newspaper' );
                                        $importer_args = [
                                        ...
                                        echo esc_html__( 'You are all set to install the demo.', 'online-newspaper' );
                                    endif;
                                ?>
                            </span>
                            <form action="<?php echo esc_html( $_SERVER['REQUEST_URI'] ); ?>" method="post" id="online-newspaper-form">
                                <?php
                                    $nonce = wp_create_nonce( 'online_newspaper_form_action' );
                                    wp_nonce_field( 'online_newspaper_form_action', 'online_newspaper_importer_activated' ); 
                    ...
                    <div class="canvas-expand">
                        ...
                        <span class="button-label"><?php echo esc_html__( 'View all', 'online-newspaper' ); ?></span>
                    </div>
                </div>
            <?php
        }
        ...
        public function get_demo_button( $slug, $preview_url = '', $type = 'pro', $buy_url = '' ) {
            $status = $this->check_plugin_status( $this->importer_plugin_file );
            $active = in_array( $status, [ 'not-installed', 'inactive' ] );
            $install_class = 'blaze-demo-importer-modal-button';
            if( $active ) $install_class .= ' disabled';
            ?>
                <div class="demo-buttons">
                    <a href="<?php echo esc_url( $preview_url ); ?>" target="_blank" class="demo-preview demo-button"><?php echo esc_html__( 'Preview', 'online-newspaper' ); ?></a>
                    <?php
                        if( $this->is_premium || $type == 'free' ): 
                            ?>
                                <a href="#blaze-demo-importer-modal-<?php echo esc_attr( $slug ) ?>" class="<?php echo esc_attr( $install_class ); ?>">
                                    <?php echo esc_html__( 'Install', 'online-newspaper' ); ?>
                                </a>
                            <?php
                        else: 
                            ?>
                                <a href="<?php echo esc_url( $buy_url ); ?>" class="purchase-pro" target="_blank">
                                    <?php echo esc_html__( 'Buy Pro', 'online-newspaper' ); ?>
                                </a>
                            <?php
                        endif;
                    ?>
        ...
        public function get_demo_label( $type ) {
            ...
            switch( $type ) :
                case 'free':
                    return esc_html__( 'Free', 'online-newspaper' );
                    break;
                case 'pro':
                    return esc_html__( 'Pro', 'online-newspaper' );
                    break;
                default:
                    return esc_html__( 'Default', 'online-newspaper' );
                    break;
            endswitch;
        }
        ...
        public function plugin_status_button( $status, $importer = false, $args = [] ) {
            ...
            switch( $status ) :
                case 'not-installed' :
                    $label = $importer ? esc_html__( 'Here', 'online-newspaper' ) : esc_html__( 'Install and Activate', 'online-newspaper' );
                    $class .= ' action-trigger not-installed';
                    break;
                case 'active' :
                    $class .= ' active';
                    $property = ' disabled';
                    $label = esc_html__( 'Installed & Activated', 'online-newspaper' );
                    if( $importer ) :
                        $property = '';
                        $class .= ' importer';
                        $label = esc_html__( 'Import', 'online-newspaper' );
                    endif;
                    break;
                case 'inactive' :
                    $label = $importer ? esc_html__( 'activate', 'online-newspaper' ) : esc_html__( 'Activate', 'online-newspaper' );
                    $class .= ' inactive';
         ...
         * @since 1.0.0
         */
        public function online_newspaper_importer_plugin_action() {
            $this->plugin_active_install_action( 'online-newspaper-theme-info-nonce' );
        }
        ...
        public function plugin_active_install_action( $nonce = '' ) {
            ...
            if( $_plugin_action === 'inactive' ) {
                ...
                $this->ajax_response['message'] = ( $importer_or_not == 'true' ) ? esc_html__( 'Plugin activated', 'online-newspaper' ) : esc_html__( 'Demo importer plugin activated', 'online-newspaper' );
            ...
            $this->ajax_response['message'] = esc_html__( 'Error while trying to install or active the plugin.', 'online-newspaper' );
            $this->send_ajax_response();
        }
            ...
            ?>
                <div class="wrap blaze-demo-importer-demo-importer-wrap">
                                ...
                                ?>
                                    <div id="blaze-demo-importer-modal-<?php echo esc_attr( $demo_slug ) ?>" class="blaze-demo-importer-modal" style="display: none;">
                                        ...
                                        <div class="blaze-demo-importer-modal-header">
                                            <h2><?php printf( esc_html( 'Import %s Demo', 'online-newspaper' ), esc_html( $demo_pack['name'] ) ); ?></h2>
                                        ...
                                        <div class="blaze-demo-importer-modal-wrap">
                                            <p><?php echo sprintf( esc_html__('We recommend you backup your website content before attempting to import the demo so that you can recover your website if something goes wrong. You can use %s plugin for it.', 'online-newspaper' ), '<a href="https://wordpress.org/plugins/all-in-one-wp-migration/" target="_blank">' . esc_html__( 'All in one migration', 'online-newspaper' ) . '</a>' ); ?></p>

                                            <p><?php echo esc_html__( 'This process will install all the required plugins, import contents and setup customizer and theme options.', 'online-newspaper' ); ?></p>

                                            <div class="blaze-demo-importer-modal-recommended-plugins">
                                                <h4><?php esc_html_e( 'Required Plugins', 'online-newspaper' ); ?></h4>
                                                <p><?php esc_html_e( 'For your website to look exactly like the demo,the import process will install and activate the following plugin if they are not installed or activated.', 'online-newspaper' ); ?></p>
                                                <?php
                                                ...
                                                if ( is_array( $plugins ) ) :
                                                    ...
                                                    ?>
                                                        <ul>
                                                            <li><?php esc_html_e( 'No Required Plugins Found.', 'online-newspaper' ); ?></li>
                                                        </ul>
                                                    <?php
                                                endif;
                                                ?>
                                            ...
                                            <ul class="blaze-demo-importer-reset-checkbox">
                                                <h4><?php esc_html_e( 'Files', 'online-newspaper' ) ?></h4>
                                                <li>
                                                    <label class="blaze-demo-importer-files-checkbox">
                                                        ...
                                                        <?php echo esc_html( 'Customizer.dat', 'online-newspaper' ); ?>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="blaze-demo-importer-files-checkbox">
                                                        <input id="checkbox-widget-<?php echo esc_attr( $demo_slug ); ?>" type="checkbox" checked="checked" />
                                                        <?php echo esc_html( 'Widget.wie', 'online-newspaper' ); ?>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="blaze-demo-importer-files-checkbox">
                                                        <input id="checkbox-content-<?php echo esc_attr( $demo_slug ); ?>" type="checkbox" checked="checked" />
                                                        <?php echo esc_html( 'Content.xml.', 'online-newspaper' ); ?>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="blaze-demo-importer-files-checkbox">
                                                        <input id="checkbox-attachment-<?php echo esc_attr( $demo_slug ); ?>" type="checkbox" />
                                                        <?php echo esc_html( 'Attachments like images, audios, videos, etc.', 'online-newspaper' ); ?>
                                                    </label>
                                                </li>
                                            </ul>
                                            <a href="javascript:void(0)" class="button blaze-demo-importer-modal-cancel"><?php esc_html_e ( 'Cancel', 'online-newspaper' ); ?></a>
                                            <a href="javascript:void(0)" data-demo-slug="<?php echo esc_attr( $demo_slug ) ?>" class="button button-primary blaze-demo-importer-import-demo"><?php esc_html_e( 'Import Demo', 'online-newspaper' ); ?></a>
                                        </div>
                                    </div>
                                <?php
                            endforeach;
                    ...
                    <div id="blaze-demo-importer-import-progress" style="display: none">
                        <h2 class="blaze-demo-importer-import-progress-header"><?php echo esc_html__( 'Demo Import Progress', 'online-newspaper' ); ?></h2>
                        ...
                        <div class="blaze-demo-importer-import-progress-message"><div class="message-item"></div></div>
                            ...
                            <span class="progress-bar-note"><?php esc_html_e( 'Demo import success', 'online-newspaper' ); ?></span>
                        </div>
                        </div>
                </div>
            <?php
...
if( ! class_exists( 'Admin_Notices' ) ) :
    ...
    class Admin_Notices extends Admin_Page {
        ...
        public function __construct() { 
            add_action( 'init', function(){
                $this->restriction_message = esc_html__( "You dont have permission to perform this action", 'online-newspaper' );
            });
            ...
            add_action( 'wp_ajax_online_newspaper_admin_notice_ajax_call', [ $this, 'admin_notice_ajax_call' ] );
            add_action( 'wp_ajax_online_newspaper_importer_plugin_action_for_notice', [ $this, 'online_newspaper_importer_plugin_action_for_notice' ] );
        }
        ...
        public function admin_welcome_notice() {
            ...
            if( isset( $_GET['page'] ) && in_array( $_GET['page'], [ 'online-newspaper-info', 'blaze-system-info' ] ) ) return;

            if( get_option( 'online_newspaper_welcome_notice_dismiss' ) ) return;

            $this->notice_wrapper_open('online-newspaper-welcome-notice notice-info');
            ?>
                <div class="notice-content">
                    <div class="notice-header">
                        <h2 class="notice-title"><?php echo esc_html__( 'Thank you for activating Online Newspaper Premium Version!!', 'online-newspaper' ); ?></h2>
                    </div>
                    <p class="notice-description"><?php echo esc_html__( 'Get started with multipurpose news theme and give your site a new look. We recommend you to please go through the documentation to get started with theme and setup homepage quicky.', 'online-newspaper' ); ?></p>
                    <div class="notice-actions">
                        <a class="action-button importer" href="<?php echo admin_url( 'admin.php?page=online-newspaper-info' ); ?>"><?php echo esc_html__( 'Install Demos', 'online-newspaper' ); ?></a>
                        <a class="action-button" href="<?php echo admin_url( 'customize.php' ); ?>" target="_blank"><?php echo esc_html__( 'Customize Site', 'online-newspaper' ); ?></a>
                        <a class="action-button" href="<?php echo esc_url( '//doc.blazethemes.com/online-newspaper/' ); ?>" target="_blank"><?php echo esc_html__( 'Documentation', 'online-newspaper' ); ?></a>
                    </div>
                </div>
                <?php $this->get_notice_preview(); ?>
                <button class="alert-dismiss"><?php echo esc_html__( 'Dismiss this notice', 'online-newspaper' ); ?></button>
            <?php
        ...
        public function notice_wrapper_open( $classes = '' ) {
            if( $classes != '' ) {
                echo '<div class="online-newspaper-admin-notice notice is-dismissible ' .esc_attr( $classes ). '">';
            } else {
                echo '<div class="online-newspaper-admin-notice notice is-dismissible">';
            }
        ...
        public function notice_wrapper_close() {
            ...
            echo '</div><!-- .online-newspaper-admin-notice -->';
        }
        ...
        public function admin_notice_ajax_call() {
            check_ajax_referer( 'online-newspaper-notice-nonce', '_wpnonce' );
            ...
            $this->ajax_response['status'] = true;
            $this->ajax_response['message'] = esc_html__( 'Welcome notice hidden', 'online-newspaper' );
            $this->send_ajax_response();
            wp_die();
        }
         ...
         * @since 1.0.0
         */
        public function online_newspaper_importer_plugin_action_for_notice() {            
            $this->plugin_active_install_action( 'online-newspaper-notice-nonce' );
        }
    }
endif;