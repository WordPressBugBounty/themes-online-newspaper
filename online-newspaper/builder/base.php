    ...
    if( ! class_exists( 'Builder_Base' ) ) :
        ...
        class Builder_Base {
            ...
            protected function render_row( $row, $index ) {
                ...
                $row_sticky = ONP\online_newspaper_get_customizer_option( 'header_'. $this->get_ordinals( $index + 1 ) .'_row_header_sticky' );
            ...
            public static function widget_exists( $control_id = '', $to_search = '' ) {
                ...
                $control = ONP\online_newspaper_get_customizer_option( $control_id );
            ...
            public function get_ordinals( $number ) {
                switch( $number ) :
                    case 1:
                        return esc_html__( 'first', 'online-newspaper' );
                        break;
                    case 2:
                        return esc_html__( 'second', 'online-newspaper' );
                        break;
                    case 3:
                        return esc_html__( 'third', 'online-newspaper' );
                        break;
                endswitch;
            }
        }
